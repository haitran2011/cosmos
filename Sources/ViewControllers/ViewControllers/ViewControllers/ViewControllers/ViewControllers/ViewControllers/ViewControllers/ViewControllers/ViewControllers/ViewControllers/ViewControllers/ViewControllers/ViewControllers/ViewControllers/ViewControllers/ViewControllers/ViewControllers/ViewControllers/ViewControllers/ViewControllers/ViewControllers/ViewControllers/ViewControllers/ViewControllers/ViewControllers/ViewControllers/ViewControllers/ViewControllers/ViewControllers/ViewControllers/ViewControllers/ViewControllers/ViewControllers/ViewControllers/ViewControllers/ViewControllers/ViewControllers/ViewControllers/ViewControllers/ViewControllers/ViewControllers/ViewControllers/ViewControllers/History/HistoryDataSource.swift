...
extension HistoryDataSource: UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        switch viewType {
        case .list:
            let listCell = collectionView.dequeueReusableCell(withReuseIdentifier: HistoryVideoListCell.reuseIdentifier, for: indexPath) as! HistoryVideoListCell
...
extension HistoryDataSource: TBEmptyDataSetDelegate{
...
extension HistoryDataSource: TBEmptyDataSetDataSource{
