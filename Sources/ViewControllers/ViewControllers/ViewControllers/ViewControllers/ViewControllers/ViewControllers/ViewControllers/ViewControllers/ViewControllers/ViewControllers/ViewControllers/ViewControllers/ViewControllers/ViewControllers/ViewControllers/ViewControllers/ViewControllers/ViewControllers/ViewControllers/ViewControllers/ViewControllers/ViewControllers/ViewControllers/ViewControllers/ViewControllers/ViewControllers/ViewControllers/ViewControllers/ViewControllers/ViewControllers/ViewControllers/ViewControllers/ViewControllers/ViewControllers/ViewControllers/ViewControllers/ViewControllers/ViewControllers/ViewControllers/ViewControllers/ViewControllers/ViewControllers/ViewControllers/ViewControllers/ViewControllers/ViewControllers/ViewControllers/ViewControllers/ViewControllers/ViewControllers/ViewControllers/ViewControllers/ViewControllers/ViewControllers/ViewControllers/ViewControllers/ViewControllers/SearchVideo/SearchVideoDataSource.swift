...
class SearchVideoDataSource: NSObject {
...
extension SearchVideoDataSource: UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        switch viewType {
        case .list:
            let listCell = collectionView.dequeueReusableCell(withReuseIdentifier: SearchVideoListCell.reuseIdentifier, for: indexPath) as! SearchVideoListCell
...
extension SearchVideoDataSource: TBEmptyDataSetDelegate{
...
extension SearchVideoDataSource: TBEmptyDataSetDataSource{
    func imageForEmptyDataSet(in scrollView: UIScrollView) -> UIImage? {
        return nil//EmptyData.images[indexPath.row]
    }
    
    func titleForEmptyDataSet(in scrollView: UIScrollView) -> NSAttributedString? {
        let title = "không tìm thấy video".localized()//EmptyData.titles[indexPath.row]
