...
class ListPlayListDataSource: NSObject {
...
extension ListPlayListDataSource: UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        switch viewType {
        case .list:
            let listCell = collectionView.dequeueReusableCell(withReuseIdentifier: ListPlayListSingleCell.reuseIdentifier, for: indexPath) as! ListPlayListSingleCell
                listCell.setupCell(with: data[indexPath.row])
            return listCell
        case .grid:
            let gridCell = collectionView.dequeueReusableCell(withReuseIdentifier: ListPlayGridCell.reuseIdentifier, for: indexPath) as! ListPlayGridCell
...
extension ListPlayListDataSource: TBEmptyDataSetDelegate{
...
extension ListPlayListDataSource: TBEmptyDataSetDataSource{
